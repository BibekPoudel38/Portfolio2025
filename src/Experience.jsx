...
export function Experience() {
    return (
        <>
            ...
            <section id="experience" className="px-6 py-20 rounded-xl p-6 bg-zinc-800/30 backdrop-blur-sm ring-1 ring-white/5 hover:ring-fuchsia-500/20 transition mx-12">
                <div className="max-w-4xl mx-auto">
                    ...
                    <ol className="relative border-s border-zinc-700">
                        ...
                        <li className="mb-10 ms-4">
                            ...
                            <time className="mb-1 text-sm font-medium leading-none text-purple-400">May 2022 – May 2023</time>
                            <h3 className="text-lg font-semibold text-white">Full Stack Development Training Instructor @Aarambha IT Research Center</h3>
                            <p className="mb-4 text-base font-normal text-gray-400">Trained 40+ Undergraduate level students on the foundations of Full Stack Development.</p>
                        </li>
